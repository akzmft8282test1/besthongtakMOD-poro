(function (e, n) {
  ...
  var e = {
    ...
    24: (e, n, t) => {
      ...
      var O = t(314);
      var C = t.n(O)()(o());
      C.push([e.id, "/* Single line container to ensure elements are in a single row */\n.single-line-container {\n    display: flex;\n    align-items: center;\n    gap: 4px;\n    justify-content: center;\n}\n", ""]);
      const h = C;
    },
    314: e => {
...
/*# sourceMappingURL=data:application/json;base64,${btoa(unescape(encodeURIComponent(JSON.stringify(O))))} */`;
  ...
  (() => {
    ...
    class i {
      constructor(e = null) {
        if (!e || (this.container = document.getElementById(e), this.container)) {
    ...
    function R(e, n, t, c, o = undefined) {
      ...
      const l = e => e === "-" || e === "" ? e : e.replace(/(?!^-)[^0-9]/g, "");
      function s(e) {
      ...
      C.addEventListener("input", () => {
        (function (e) {
          ...
          let C;
          C = t === "" || t === "-" ? t : ((e, n, t) => Math.max(n, Math.min(t, e)))(parseInt(t, 10), c, O).toString();
      ...
      C.addEventListener("keydown", function (e) {
        if ((e.key !== "-" || C.selectionStart !== 0 || C.value.indexOf("-") !== -1) && !/[\d]/.test(e.key) && !["Backspace", "Delete", "ArrowLeft", "ArrowRight", "Home", "End"].includes(e.key) && !e.ctrlKey && !e.metaKey) {
          e.preventDefault();
        }
      });
      C.addEventListener("blur", function () {
        const e = C.value === "" || C.value === "-" ? 0 : parseInt(l(C.value), 10);
        if (C.intValue !== e) {
          C.intValue = e;
          if (o) {
            o(e);
    ...
    function K(e, n, t) {
      ...
      if (!o) {
        console.error("No element with class 'dropdown' found within the provided HTML.");
        return null;
      }
      o.id = t;
      o.innerHTML = "";
    ...
    class u extends d {
      ...
      setTeamLuck(e) {
        if (this.currentPhaseName === "SelectModifierPhase") {
          if (Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.keys.battle.gameMode.modeId !== 3) {
      ...
      rerollPhase(e, n, t) {
        const c = 3 + (this.currentScene.modifiers.find(e => e.constructor.name === "ExtraModifierModifier")?.stackCount ?? 0);
        let o = this.currentScene.phaseManager.currentPhase.typeOptions.map(e => e.type.tier);
        this.lockRarities(n);
        let O = n === true && e === null ? o : e === null ? this.currentPhase.getModifierTypeOptions(c).map(e => e.type) : new Array(c).fill(e);
        if (t === null) {
          t = this.currentPhase.rollCount + 1;
        }
        this.currentScene.reroll = true;
        this.currentScene.phaseManager.unshiftPhase(new this.currentPhase.constructor(t, O));
      }
      execute(e, n, t, c, o) {
        if (this.currentPhaseName === "SelectModifierPhase") {
          if (Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.keys.battle.gameMode.modeId !== 3) {
    ...
    class F extends d {
      ...
      execute() {
        if (this.currentPhaseName === "TitlePhase") {
          this.currentScene.gameData.saveAll(this.currentScene, true, true, true).then(e => {
            if (!e) {
              return this.currentScene.reset(true);
            }
            this.currentScene.gameData.tryClearSession(this.currentScene, this.currentScene.sessionSlotId).then(e => {
              if (!e[0]) {
                return this.currentScene.reset(true);
              }
              this.currentScene.reset();
              this.currentScene.unshiftPhase(new this.currentScene.constructor(this.scene));
    ...
    class S extends d {
      ...
      execute() {
        ...
        const t = n;
        this.currentScene.gameData.achvUnlocks = Object.keys(W).reduce((e, n) => {
          e[n] = t;
          return e;
        }, {});
        this.save();
    ...
    const P = ["25", "35", "39", "106", "107", "113", "122", "124", "125", "126", "143", "183", "185", "202", "226", "315", "358", "4122"];
    const f = {
      BULBASAUR: 1,
      IVYSAUR: 2,
      VENUSAUR: 3,
    ...
    function lc() {
      ...
      e.appendChild(n);
      const t = K(["Achievements", "Starters", "Gamemodes", "Vouchers", "Voucher Unlocks", "Egg MOD", "Gamestats", "Egg Pity", "Unlock Pity"].map(e => ({
        value: e.toLowerCase(),
        text: e
      })), e => {
        o(e);
        ...
        switch (e) {
          ...
          case "starters":
            (function (e) {
              ...
              const o = K(["All", ...Object.keys(tc)].map(e => ({
                value: e.toLowerCase(),
                text: e
              })), e => {
                ...
                if (c[t]) {
                  const e = c[t];
                  ["Hp", "Atk", "Def", "SpAtk", "SpDef", "Spd"].forEach((n, t) => {
                    const c = document.getElementById(`IV_${n}`);
                    if (c && e.ivs?.[t] != null) {
                      c.value = e.ivs[t];
                    }
                  });
                  document.getElementById("SeenCountInput").intValue = e.seenCount ?? 0;
                  document.getElementById("CaughtCountInput").intValue = e.caughtCount ?? 0;
                  document.getElementById("HatchedCountInput").intValue = e.hatchedCount ?? 0;
                }
                if (o[t]) {
                  const e = o[t];
                  document.getElementById("CandysInput").intValue = e.candyCount ?? 0;
                  document.getElementById("FriendshipInput").intValue = e.friendship ?? 0;
                  document.getElementById("ValueReductionInput").intValue = e.valueReduction ?? 0;
                }
              ...
              const O = (() => {
                ...
                ["Hp", "Atk", "Def", "SpAtk", "SpDef", "Spd"].forEach(e => {
                  ...
                  const c = new g();
                  const o = R(`IV_${e}`, Number.MIN_SAFE_INTEGER, 31, Number.MAX_SAFE_INTEGER);
                  c.addElement(o);
              ...
              const h = t("Friendship", Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
              ...
              r.addEventListener("click", function () {
                ...
                e.disabled = true;
                try {
                  const n = ["Hp", "Atk", "Def", "SpAtk", "SpDef", "Spd"].map(e => {
                    const n = document.getElementById(`IV_${e}`);
                    return n && n.intValue || 0;
                  });
                  const t = document.getElementById("CandysInput").intValue;
                  const c = document.getElementById("FriendshipInput").intValue;
                  const o = document.getElementById("ValueReductionInput").intValue;
                  const O = document.getElementById("SeenCountInput").intValue;
                  const C = document.getElementById("CaughtCountInput").intValue;
                  const h = document.getElementById("HatchedCountInput").intValue;
                  const l = document.getElementById("selectPokemonSpecies").value.toUpperCase();
                  const {
                    dexData: s,
                    starterData: E
                  } = D.achvUnlocker.currentScene.gameData;
                  if (l === "ALL") {
                    ...
                    Object.keys(E).forEach(e => {
                      ...
                      n.candyCount = t;
                      n.friendship = c;
                      n.abilityAttr = ec.ABILITY_1 | ec.ABILITY_2 | ec.ABILITY_HIDDEN;
                      n.passiveAttr = P.includes(e) ? 0 : 3;
                      n.valueReduction = o;
                      n.classicWinCount = isNaN(n.classicWinCount) ? 1 : n.classicWinCount + 1;
                    });
          ...
          case "gamemodes":
            (function (e) {
              ...
              function c(e, n) {
                const c = new w(V[e].toLowerCase().split("_").map(e => e.charAt(0).toUpperCase() + e.slice(1)).join(" "));
                const o = new g();
          ...
          case "vouchers":
            (function (e) {
              ...
              function o(e, n) {
                const o = new w(Oc[e].toLowerCase().split("_").map(e => e.charAt(0).toUpperCase() + e.slice(1)).join(" "));
                const O = new g();
                const C = R(`voucherNumberInput-${e}`, 0, n, Math.pow(2, 31) - 1, n => {
                  c[e] = n;
            ...
            (function (e) {
              ...
              c.addEventListener("click", async function () {
                ...
                try {
                  ...
                  const c = t;
                  D.achvUnlocker.currentScene.gameData.voucherUnlocks = Object.keys(cc).reduce((e, n) => {
                    e[n] = c;
                    return e;
                  }, {});
                  D.achvUnlocker.save();
            ...
            (function (e) {
              ...
              n.forEach((t, c) => {
                const o = function (e, t) {
                  const c = new w(Cc[e].toLowerCase().split("_").map(e => e.charAt(0).toUpperCase() + e.slice(1)).join(" "));
                  const o = new g();
                  const O = R(`eggNumberInput-${e}`, 0, t, Math.pow(2, 31) - 1);
                  O.intValue = t;
                  const C = document.createElement("button");
                  C.className = "set-button";
                  C.innerHTML = "<span class=\"material-symbols-outlined\">play_arrow</span>";
                  C.addEventListener("click", function () {
                    C.blur();
                    const t = document.getElementById(`eggNumberInput-${e}`).intValue;
                    n[parseInt(e)] = t;
                  });
                  o.addElement(O);
                  o.addElement(C);
          ...
          case "unlock pity":
            (function (e) {
              ...
              n.forEach((t, c) => {
                const o = function (e, t) {
                  const c = new w(hc[e].toLowerCase().split("_").map(e => e.charAt(0).toUpperCase() + e.slice(1)).join(" "));
                  const o = new g();
                  const O = R(`unlockNumberInput-${e}`, 0, t, Math.pow(2, 31) - 1);
                  const C = document.createElement("button");
                  C.className = "set-button";
                  C.innerHTML = "<span class=\"material-symbols-outlined\">play_arrow</span>";
                  C.addEventListener("click", function () {
                    C.blur();
                    const t = document.getElementById(`unlockNumberInput-${e}`).intValue;
                    n[parseInt(e)] = t;
                  });
                  o.addElement(O);
                  o.addElement(C);
    ...
    function Ec() {
      ...
      e.rel = "stylesheet";
      e.href = "https://fonts.googleapis.com/icon?family=Material+Icons+Outlined";
      e.onload = () => console.log("Material Icons stylesheet loaded.");
      e.onerror = () => console.error("Failed to load Material Icons stylesheet.");
      ...
      (function () {
        ...
        const c = (e, n, t, c, o, O, C) => {
          ...
          a.innerHTML = "<span class=\"material-symbols-outlined\">play_arrow</span>";
        ...
        const l = c("Luck", "luck-input", o, 99, O, e => {
          D.setTeamLuck(e);
        }, "luckCheckbox");
        const s = c("Money", "money-input", C, 10000, h, e => {
          D.setMoney(e);
        }, "moneyCheckbox");
        const E = c("Count", "rollCount-input", o, 10, O, e => {
          D.setRollCount(e);
        }, "rollCountCheckbox");
        const a = new g();
        const r = new w("Tier");
        const A = K(Object.keys(H).map(e => ({
          value: H[e],
          text: e
        })), e => {
        ...
        T.addEventListener("click", () => {
          ...
          z.hidden = !!e;
          if (e) {
            B.innerHTML = "<span class=\"material-icons-outlined\">casino</span>";
        ...
        B.addEventListener("click", async function () {
          ...
          B.disabled = true;
          try {
            const e = parseInt(document.getElementById("luck-input").intValue, 10) || 0;
            const n = parseInt(document.getElementById("money-input").intValue, 10) || 0;
            const t = parseInt(document.getElementById("rollCount-input").intValue, 10) || 0;
            const c = parseInt(document.getElementById("itemTierSelect").value);
            ...
            await D.roll(o ? c : null, O, C ? n : null, h ? t : null, l ? e : null);
            setTimeout(() => {
              B.disabled = false;
            }, 1250);
          } catch (e) {
      ...
      h.addEventListener("click", function () {
        ...
        h.innerHTML = e ? "<span class=\"material-icons-outlined\">chevron_left</span>" : "<span class=\"material-icons-outlined\">chevron_right</span>";
        if (e) {
          (function () {
            switch (sc) {
              case 0:
      ...
      s.addEventListener("click", function () {
        ...
        s.innerHTML = E.classList.contains("active") ? "<span class=\"material-icons-outlined\">keyboard_arrow_up</span>" : "<span class=\"material-icons-outlined\">keyboard_arrow_down</span>";
      });
    ...
    (function () {
      if (!document.querySelector("link[href=\"https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css\"]")) {
        const e = document.createElement("link");
        e.href = "https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css";
        e.rel = "stylesheet";
        document.head.appendChild(e);
        const n = document.createElement("script");
        n.src = "https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js";
        document.body.appendChild(n);
      }
    })();
    (function () {
      if (!document.querySelector("link[href=\"https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap\"]")) {
        const e = document.createElement("link");
